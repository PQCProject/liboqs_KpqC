...
#define OQS_KEM_ntru_plus_kem576_neon_length_public_key  864
#define OQS_KEM_ntru_plus_kem576_neon_length_secret_key  1760
#define OQS_KEM_ntru_plus_kem576_neon_length_ciphertext  864
#define OQS_KEM_ntru_plus_kem576_neon_length_keypair_seed  0
#define OQS_KEM_ntru_plus_kem576_neon_length_shared_secret  32
...
OQS_API OQS_STATUS OQS_KEM_ntru_plus_kem576_neon_keypair_derand(uint8_t *public_key, uint8_t *secret_key, const uint8_t *keypair_seed);
